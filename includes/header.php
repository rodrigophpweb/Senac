            ...
            <div class="row">
                <div class="col-lg-12 text-right">
                    <nav class="navbar navbar-expand-lg">                        
                        <a class="navbar-brand" href="https://www.sp.senac.br/">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavDropdown">
                          <ul class="navbar-nav ml-auto">
                            <li class="nav-item active">
                                <a class="nav-link" href="#">Institucional <span class="sr-only">(current)</span></a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#">Centro Universitário</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="#">Programa de Aprendizagem</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="#">Bolsas de Estudo</a>
                            </li>
